      ...
      <main className="dark:bg-gray-800">
        ...
        <section>
          <div className="container">
            ...
            <div className="flex flex-col items-center pl-[0px] sm:grid sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4 xl:flex xl:flex-row justify-center gap-[40px] pt-[30px] pb-[32px]">
        ...
        <section className="pb-[65px]">
          <div className="container">
            ...
            <div className="flex flex-col items-center sm:grid grid-cols-2 px-[5px] lg:flex sm:flex-row gap-[40px] pb-[30px]">
              <div>
                <div>
